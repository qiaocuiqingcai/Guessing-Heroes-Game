...
class Index(IndexOpsMixin, PandasObject):
    ...
    def view(self, cls=...): # -> DatetimeIndex | Index | TimedeltaIndex | ndarray[_AnyShape, dtype[Any]] | Self | ExtensionArray:
        ...
    ...
    def sortlevel(self, level=..., ascending: bool | list[bool] = ..., sort_remaining=..., na_position: NaPosition = ...): # -> tuple[Self, ndarray[_AnyShape, dtype[Any]]]:
        """
    ...
    def __reduce__(self): # -> tuple[Callable[..., PeriodIndex | MultiIndex | Any], tuple[type[Self], dict[str, ExtensionArray | ndarray[_AnyShape, dtype[Any]] | Hashable]], None]:
        ...
    ...
    def min(self, axis=..., skipna: bool = ..., *args, **kwargs): # -> NaTType | float | object | Self | NDArray[Any] | Any | str | bool | Period | Timestamp | Timedelta | Interval[Any] | datetime64[date | int | None] | timedelta64[timedelta | int | None] | date:
        """
    ...
    def max(self, axis=..., skipna: bool = ..., *args, **kwargs): # -> NaTType | float | object | Self | NDArray[Any] | Any | str | bool | Period | Timestamp | Timedelta | Interval[Any] | datetime64[date | int | None] | timedelta64[timedelta | int | None] | date:
        """
