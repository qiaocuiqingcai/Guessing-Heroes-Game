...
@pytest.fixture(params=[None, "gzip", "bz2", "zip", "xz", "tar", pytest.param("zstd", marks=td.skip_if_no("zstandard"))])
...
def index(request): # -> MultiIndex | CategoricalIndex | DatetimeIndex | Index | IntervalIndex | PeriodIndex | RangeIndex | TimedeltaIndex:
    """
...
def index_flat(request): # -> MultiIndex | CategoricalIndex | DatetimeIndex | Index | IntervalIndex | PeriodIndex | RangeIndex | TimedeltaIndex:
    """
...
def index_with_missing(request): # -> MultiIndex | CategoricalIndex | DatetimeIndex | Index | IntervalIndex | PeriodIndex | RangeIndex | TimedeltaIndex:
    """
...
def index_or_series_obj(request): # -> MultiIndex | CategoricalIndex | DatetimeIndex | Index | IntervalIndex | PeriodIndex | RangeIndex | TimedeltaIndex | Series:
    """
...
def index_or_series_memory_obj(request): # -> MultiIndex | CategoricalIndex | DatetimeIndex | Index | IntervalIndex | PeriodIndex | RangeIndex | TimedeltaIndex | Series:
    """
...
@pytest.fixture(params=[(Interval(left=0, right=5), IntervalDtype("int64", "right")), (Interval(left=0.1, right=0.5), IntervalDtype("float64", "right")), (Period("2012-01", freq="M"), "period[M]"), (Period("2012-02-01", freq="D"), "period[D]"), (Timestamp("2011-01-01", tz="US/Eastern"), DatetimeTZDtype(unit="s", tz="US/Eastern")), (Timedelta(seconds=500), "timedelta64[ns]")])
...
@pytest.fixture(params=[("python", pd.NA), pytest.param(("pyarrow", pd.NA), marks=td.skip_if_no("pyarrow")), pytest.param(("pyarrow", np.nan), marks=td.skip_if_no("pyarrow")), ("python", np.nan)], ids=["string=string[python]", "string=string[pyarrow]", "string=str[pyarrow]", "string=str[python]"])
...
@pytest.fixture(params=[pytest.param(("pyarrow", np.nan), marks=td.skip_if_no("pyarrow")), pytest.param(("pyarrow", pd.NA), marks=td.skip_if_no("pyarrow"))])
...
@pytest.fixture(params=[np.dtype("object"), ("python", pd.NA), pytest.param(("pyarrow", pd.NA), marks=td.skip_if_no("pyarrow")), pytest.param(("pyarrow", np.nan), marks=td.skip_if_no("pyarrow")), ("python", np.nan)], ids=["string=object", "string=string[python]", "string=string[pyarrow]", "string=str[pyarrow]", "string=str[python]"])
...
@pytest.fixture(params=[("foo", None, None), ("Egon", "Venkman", None), ("NCC1701D", "NCC1701D", "NCC1701D"), (np.nan, np.nan, np.nan), (np.nan, pd.NaT, None), (np.nan, pd.NA, None), (pd.NA, pd.NA, pd.NA)])
