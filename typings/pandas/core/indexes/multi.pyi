...
class MultiIndex(Index):
    ...
    def __reduce__(self): # -> tuple[Callable[..., PeriodIndex | MultiIndex | Any], tuple[type[Self], dict[str, list[Any] | int | None]], None]:
    ...
    def get_loc(self, key): # -> Any | slice[NDArray[intp] | intp, NDArray[intp] | intp, Any] | ndarray[Any, Any] | ndarray[_AnyShape, dtype[bool_]] | ndarray[_AnyShape, dtype[Any]] | slice[Any, Any, Any] | _Array1D[Any] | int | integer[Any] | slice[int, int, Any] | ndarray[tuple[int], dtype[signedinteger[_NBitIntP]]]:
        """
