...
def set_nulls(data: np.ndarray | pd.Series, col: Column, validity: tuple[Buffer, tuple[DtypeKind, int, str, str]] | None, allow_modify_inplace: bool = ...): # -> ndarray[_AnyShape, dtype[Any]] | Series:
    """
