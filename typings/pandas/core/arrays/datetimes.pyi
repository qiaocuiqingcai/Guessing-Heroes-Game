...
class DatetimeArray(dtl.TimelikeOps, dtl.DatelikeOps):
    ...
    def astype(self, dtype, copy: bool = ...): # -> Self | NDArray[object_] | ndarray[tuple[int, ...], dtype[Any]] | ExtensionArray | NDArray[int64] | NDArray[Any] | PeriodArray:
        ...
...
def objects_to_datetime64(data: np.ndarray, dayfirst, yearfirst, utc: bool = ..., errors: DateTimeErrorChoices = ..., allow_object: bool = ..., out_unit: str = ...): # -> tuple[ndarray[_AnyShape, dtype[Any]], tzinfo] | tuple[ndarray[_AnyShape, dtype[Any]], None]:
    """
