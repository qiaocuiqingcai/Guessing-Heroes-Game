...
class IntervalIndex(ExtensionIndex):
    ...
    def __new__(cls, data, closed: IntervalClosedType | None = ..., dtype: Dtype | None = ..., copy: bool = ..., name: Hashable | None = ..., verify_integrity: bool = ...) -> Self:
        ...
    
    @classmethod
    @Appender(_interval_shared_docs["from_breaks"] % { "klass": "IntervalIndex","name": textwrap.dedent("""
             name : str, optional
                  Name of the resulting IntervalIndex."""),"examples": textwrap.dedent("""\
        Examples
        --------
