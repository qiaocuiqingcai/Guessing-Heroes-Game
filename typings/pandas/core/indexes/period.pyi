...
class PeriodIndex(DatetimeIndexOpsMixin):
    ...
    def __new__(cls, data=..., ordinal=..., freq=..., dtype: Dtype | None = ..., copy: bool = ..., name: Hashable | None = ..., **fields) -> Self:
        ...
    ...
    def get_loc(self, key): # -> slice[Any, Any, Any] | NDArray[intp] | int | ndarray[_AnyShape, dtype[Any]]:
        """
